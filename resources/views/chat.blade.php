    ...
    <div
        ...
        <div class="lg:w-8/12 bg-white dark:bg-gray-800" id="chat_id">
            ...
            @if(Session()->has('chat_id'))
                ...
                <div class="border-t dark:border-gray-600" id="chat_scroll">
...
$(document).ready(function(){
    ...
    // $(window).load(function() {
      // $(".simplebar-content").animate({ scrollTop: $('.simplebar-content').height() }, 1000);
      // $("html, body").animate({ scrollTop: $(".simplebar-content").scrollTop() }, 1000);
    // });
...
//     var element = document.getElementById("chat_scroll");
